...
const mainBody = {
  ...
  middleName: "",
  lastName: "Ebrahim",
  message: "Electrical/Computer Engineering and Computer Science at Duke University",
  icons: [
    {
      image: "fa-github",
      url: "https://github.com/AdamEbrahim",
    },
    {
      image: "fa-linkedin",
      url: "https://www.linkedin.com/in/adam-ebrahim-120799214/",
    },
  ],
};
...
const about = {
  show: true,
  heading: "About Me",
  imageLink: require("../editable-stuff/headshotcopy.jpg"),
  imageSize: 375,
  message:
...
const repos = {
  ...
  gitHubUsername: "AdamEbrahim", //i.e."johnDoe12Gh"
  reposLength: 0,
  specificRepos: ["Squat-Device", "workout-generator-backend", "workout-generator-frontend"],
};
...
const leadership = {
  ...
  images: [
    { 
      img: require("../editable-stuff/headshotcopy.jpg"), 
...
export { navBar, mainBody, about, repos, skills, leadership, getInTouch, experiences, separateProjects};
